...
log_file = os.path.join(script_dir, 'performance_monitoring.log')
...
def performance_monitoring():
    ...
    info('*** Configuring performance monitoring\n')
    logging.info('Configuring performance monitoring')
    ...
    monitoring_data = s1.cmd('ovs-vsctl list mirror m0')
