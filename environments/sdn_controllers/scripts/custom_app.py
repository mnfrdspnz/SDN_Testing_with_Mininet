...
log_file = os.path.join(script_dir, 'custom_app.log')
...
def custom_app():
    ...
    # Deploy and test the custom SDN application
    info('*** Deploying custom SDN application\n')
    logging.info('Deploying custom SDN application')
    # Example: Run a custom script or command
    # os.system('python3 custom_app_script.py')
