...
log_file = os.path.join(script_dir, 'nvgre_basic.log')
...
def nvgre_basic():
    ...
    # Configure NVGRE tunnel
    info('*** Configuring NVGRE tunnel\n')
    logging.info('Configuring NVGRE tunnel')
    s1.cmd('ovs-vsctl add-port s1 nvgre0 -- set interface nvgre0 type=nvgre options:remote_ip=10.0.0.2')
    s2.cmd('ovs-vsctl add-port s2 nvgre0 -- set interface nvgre0 type=nvgre options:remote_ip=10.0.0.1')
